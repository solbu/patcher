...
HELP = """\
Usage: patcher unignore [OPTIONS] PATHS

This command will revert the effect of the ignore command.

Options:
    -h      Show this message

Examples:
    patcher unignore dir/file1 dir/file2
"""
...
def unignore(paths):
    ...
    for dir in dirorder:
        Manager(dir).unignore(direntries[dir])
 
def main():
    do_command(parse_options, unignore)
